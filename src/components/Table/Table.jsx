                    ...
                    data.map( ticket => (
                        ...
                        <td data-label="Opciones">
                            <div className="action_buttons grid grid-cols-2 ml-2 gap-x-10 gap-y-2 ">
                               <Button to={`/update/${ticket.ticket_id}`}        path="M5 8a4 4 0 1 1 7.796 1.263l-2.533 2.534A4 4 0 0 1 5 8Zm4.06 5H7a4 4 0 0 0-4 4v1a2 2 0 0 0 2 2h2.172a2.999 2.999 0 0 1-.114-1.588l.674-3.372a3 3 0 0 1 .82-1.533L9.06 13Zm9.032-5a2.907 2.907 0 0 0-2.056.852L9.967 14.92a1 1 0 0 0-.273.51l-.675 3.373a1 1 0 0 0 1.177 1.177l3.372-.675a1 1 0 0 0 .511-.273l6.07-6.07a2.91 2.91 0 0 0-.944-4.742A2.907 2.907 0 0 0 18.092 8Z"/>
                        ...
                        <td >
                            <Link to = {`/update/${ticket.ticket_id}`} >
...
// ASIGNAR A VICIDIAL Y MARCACION MANUEL EN GRUPO INCUBADORA ALICIA ARMAS A 
// EJECUTIVOS : 
// CARMONA RUIZ BRENDA SHIRLEY 21918
// MEDORIO MARTINEZ DIANA MARIA 21922 
// ORTEGA SERRANO BRANDON ARMANDO 21921 